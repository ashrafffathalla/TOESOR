...
class _MapScreenState extends State<MapScreen> {
                              ...
                              return Stack(children: [
                                MapScreenCubit
                                  ...
                                  CameraPosition(
                                    ...
                                    bearing: 0.0,
                                    target: LatLng(41.864310, 12.649290),
                                    tilt: 0.0,
                                    zoom: 17.0,
                                  ),
                                )
  ...
  Widget buildSecondTabMAP(context, List<DataModel> data, int index, bool isEven) =>
      GestureDetector(
        onTap: () {
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  if (data[index].length == '1' || data[index].length == '2')
                                    Row(
                                      children: const [
                                        ColorDot(),
                                        ColorDot(
                                  ...
                                  if (data[index].length == '3' || data[index].length == '4')
                                    Row(
                                      children: const [
                                        ColorDot(),
                                        ColorDot(
                                  ...
                                  if (data[index].length == '5'|| data[index].length == '6')
                                    Row(
                                      children: const [
                                        ColorDot(),
                                        ColorDot(
                                  ...
                                  if (data[index].length == '7'|| data[index].length == '8')
                                    Row(
                                      children: const [
                                        ColorDot(),
                                        ColorDot(
                                  ...
                                  if (data[index].length == '9'|| data[index].length == '10')
                                    Row(
                                      children: const [
                                        ColorDot(),
                                        ColorDot(
                                  ...
                                  if (data[index].length == '11'|| data[index].length == '12'
                                      || data[index].length == '13'|| data[index].length == '14'
                                      || data[index].length == '15'|| data[index].length == '16'
                              ...
                              Text(
                                ...
                                MapScreenCubit.get(context).roundDistanceInKM! < 1000?
                                 '${MapScreenCubit.get(context).roundDistanceInKM}'
                                    :'${MapScreenCubit.get(context).roundDistanceInKM!}',
                          //double.parse(0.001.toStringAsFixed(1))
                                style: TextStyle(
                                    fontSize: 18.sp,
                                    fontWeight: FontWeight.w400,
                                    fontFamily: 'Comfortaa'
